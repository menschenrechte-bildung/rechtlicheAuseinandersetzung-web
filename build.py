...
def build():
    ...
    translations = {
        "de": {
            "meta_title": "Verantwortung für Bildung übernehmen – Recht & Selbstbestimmung",
            "meta_desc": "Eine persönliche Geschichte über die Wahrung des Rechts auf Bildung, den Erfolg in eigener Verantwortung und das Aufzeigen staatlicher Grenzen.",
            "badge": "Bildung & Selbstbestimmung",
            "title": "Verantwortung für Bildung übernehmen",
            "subtitle": "Wo staatliche Institutionen Gesetze und Bildungsaufträge missachten, übernehmen Eltern und Kinder selbst die Verantwortung – für nachhaltigen Bildungserfolg und echte Lernfreude.",
            ...
            "hero_quote_text": "„Erst glaubte ich an das System. Doch als staatliche Stellen Gesetze, Erziehungsziele und Lernfreude missachteten, wartete ich nicht länger ab. Ich habe selbst die Verantwortung für die Bildung meines Sohnes übernommen – für ein Leben in Selbstbestimmung, mit Spitzennoten und einem Kind, das seine Freude am Lernen wiedergefunden hat.“",
            "hero_btn_story": "📖 Die ganze Story lesen",
            "hero_btn_docs": "📁 Beweise & Dokumente"
        },
        "en": {
            "meta_title": "Taking Responsibility for Education – Rights & Autonomy",
            "meta_desc": "A personal journey of upholding the right to education, achieving success through parental responsibility, and challenging state overreach.",
            "badge": "Education & Autonomy",
            "title": "Taking Responsibility for Education",
            "subtitle": "Where state institutions disregard laws and educational duties, parents and children take responsibility into their own hands – ensuring genuine learning joy and academic success.",
